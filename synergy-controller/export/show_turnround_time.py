...
# 读取第一个CSV文件
df1 = pd.read_csv('/home/tank/chm/synergy-agent/synergy-controller/export/result_Synergy_CDF_hw_500_luan_poisson/result/agent1_4.csv')

# 读取第二个CSV文件
df2 = pd.read_csv('/home/tank/chm/synergy-agent/synergy-controller/export/result_OpenFaaS_CDF_hw_500_luan_poisson/result/agent11_14.csv')

df3 = pd.read_csv('/home/tank/chm/synergy-agent/synergy-controller/export/result_OpenWhisk_CDF_hw_500_luan_poisson/result/agent11_14.csv')

df4 = pd.read_csv('/home/tank/chm/synergy-agent/synergy-controller/export/result_SFS_CDF_hw_500_luan_poisson/result/agent11_14.csv')
...
# with open("/home/tank/chm/synergy-agent/synergy-controller/export/result_Synergy_CDF_hw_500_luan_poisson/result/agent1_4.csv.txt", "r") as f:
#     print(f.readlines()[-1])
print("openfaas", df2["turn-round time"][:int(ratio*len(df1))].mean())
# with open("/home/tank/chm/synergy-agent/synergy-controller/export/result_OpenFaaS_CDF_hw_500_luan_poisson/result/agent11_14.csv.txt", "r") as f:
#     print(f.readlines()[-1])
