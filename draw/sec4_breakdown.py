...
trace = "hw"
hw_sg_trace = pd.read_csv(f'./synergy-controller/export/result_Synergy_CDF_{trace}_500_burst/result/agent1_8.csv')
hw_sg_stage1 = hw_sg_trace['t1-t0'].mean()
hw_sg_stage2 = 7.5
hw_sg_stage3 = hw_sg_trace['t2-t1'].mean()
hw_sg_stage4 = hw_sg_trace['cpu time'].mean()

hw_sgf_trace = pd.read_csv(f'./synergy-controller/export/result_Synergy_force_CDF_{trace}_500_burst/result/agent1_8.csv')
hw_sgf_stage1 = hw_sgf_trace['t1-t0'].mean()
hw_sgf_stage2 = 7.5
hw_sgf_stage3 = hw_sgf_trace['t2-t1'].mean()
hw_sgf_stage4 = hw_sgf_trace['cpu time'].mean()

hw_of_trace = pd.read_csv(f'./synergy-controller/export/result_OpenFaaS_CDF_{trace}_500_burst/result/agent21_28.csv')
...
hw_ow_trace = pd.read_csv(f'./synergy-controller/export/result_OpenWhisk_CDF_{trace}_500_burst/result/agent21_28.csv')
...
hw_sfs_trace = pd.read_csv(f'./synergy-controller/export/result_SFS_CDF_{trace}_500_burst/result/agent21_28.csv')
...
trace = "wr"
wr_sg_trace = pd.read_csv(f'./synergy-controller/export/result_Synergy_CDF_{trace}_500_burst/result/agent1_8.csv')
wr_sg_stage1 = wr_sg_trace['t1-t0'].mean()
wr_sg_stage2 = 7.5
wr_sg_stage3 = wr_sg_trace['t2-t1'].mean()
wr_sg_stage4 = wr_sg_trace['cpu time'].mean()

wr_sgf_trace = pd.read_csv(f'./synergy-controller/export/result_Synergy_force_CDF_{trace}_500_burst/result/agent1_8.csv')
wr_sgf_stage1 = wr_sgf_trace['t1-t0'].mean()
wr_sgf_stage2 = 7.5
wr_sgf_stage3 = wr_sgf_trace['t2-t1'].mean()
wr_sgf_stage4 = wr_sgf_trace['cpu time'].mean()

wr_of_trace = pd.read_csv(f'./synergy-controller/export/result_OpenFaaS_CDF_{trace}_500_burst/result/agent21_28.csv')
wr_of_stage1 = wr_of_trace['t1-t0'].mean()
wr_of_stage2 = 0
wr_of_stage3 = wr_of_trace['t2-t1'].mean()
wr_of_stage4 = wr_of_trace['cpu time'].mean()

wr_ow_trace = pd.read_csv(f'./synergy-controller/export/result_OpenWhisk_CDF_{trace}_500_burst/result/agent21_28.csv')
wr_ow_stage1 = wr_ow_trace['t1-t0'].mean()
wr_ow_stage2 = 0
wr_ow_stage3 = wr_ow_trace['t2-t1'].mean()
wr_ow_stage4 = wr_ow_trace['cpu time'].mean()

wr_sfs_trace = pd.read_csv(f'./synergy-controller/export/result_SFS_CDF_{trace}_500_burst/result/agent21_28.csv')
...
print('hw_sgf', hw_sgf_stage1, hw_sgf_stage2, hw_sgf_stage3, hw_sgf_stage4)
...
print('wr_sgf', wr_sgf_stage1, wr_sgf_stage2, wr_sgf_stage3, wr_sgf_stage4)
...
x = [3]
axes[0].barh(x, hw_sgf_stage1, width, label=labels[0], color=default_colors[0], edgecolor='black', linewidth=lw, zorder=10)
axes[0].barh(x, hw_sgf_stage2, width, left=0, label=labels[1], color=default_colors[0], hatch='xx', edgecolor='black', linewidth=lw, zorder=10)
axes[0].barh(x, hw_sgf_stage3, width, left=hw_sgf_stage1, label=labels[2], color=default_colors[1], edgecolor='black', linewidth=lw, zorder=10)
axes[0].barh(x, hw_sgf_stage4, width, left=hw_sgf_stage1, label=labels[3], color=default_colors[1], hatch='xx', edgecolor='black', linewidth=lw, zorder=10)
...
axes[0].set_yticklabels(['SFS', 'OpenWhisk', 'OpenFaaS', 'Synergy-P', 'Synergy'])
axes[0].legend()
...
x = [3]
axes[1].barh(x, wr_sgf_stage1, width, label=labels[0], color=default_colors[0], edgecolor='black', linewidth=lw, zorder=10)
axes[1].barh(x, wr_sgf_stage2, width, left=0, label=labels[1], color=default_colors[0], hatch='xx', edgecolor='black', linewidth=lw, zorder=10)
axes[1].barh(x, wr_sgf_stage3, width, left=wr_sgf_stage1, label=labels[2], color=default_colors[1], edgecolor='black', linewidth=lw, zorder=10)
axes[1].barh(x, wr_sgf_stage4, width, left=wr_sgf_stage1, label=labels[3], color=default_colors[1], hatch='xx', edgecolor='black', linewidth=lw, zorder=10)
...
plt.savefig("./pdf/sec4_breakdown.pdf")
